...
func templatesBaseTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/base.tf", size: 16294, mode: os.FileMode(480), modTime: time.Unix(1513725999, 0)}
...
func templatesConcourse_lbTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/concourse_lb.tf", size: 3472, mode: os.FileMode(480), modTime: time.Unix(1513724292, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesIso_segmentsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/iso_segments.tf", size: 6448, mode: os.FileMode(480), modTime: time.Unix(1513724292, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
