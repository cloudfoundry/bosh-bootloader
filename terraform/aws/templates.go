...
func templatesBaseTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/base.tf", size: 16862, mode: os.FileMode(480), modTime: time.Unix(1515025232, 0)}
...
func templatesVpcTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/vpc.tf", size: 536, mode: os.FileMode(480), modTime: time.Unix(1515025200, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
