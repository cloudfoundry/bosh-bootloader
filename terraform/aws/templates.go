...
func templatesBaseTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/base.tf", size: 15813, mode: os.FileMode(420), modTime: time.Unix(1510616835, 0)}
...
func templatesLb_subnetTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/lb_subnet.tf", size: 1194, mode: os.FileMode(420), modTime: time.Unix(1510173138, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
