...
func templatesCf_lbTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/cf_lb.tf", size: 6629, mode: os.FileMode(480), modTime: time.Unix(1541807454, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesIso_segmentsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/iso_segments.tf", size: 8247, mode: os.FileMode(480), modTime: time.Unix(1541807566, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
