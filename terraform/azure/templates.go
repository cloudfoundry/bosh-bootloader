...
func templatesCf_dnsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/cf_dns.tf", size: 941, mode: os.FileMode(480), modTime: time.Unix(1521648120, 0)}
...
func templatesCf_lbTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/cf_lb.tf", size: 6469, mode: os.FileMode(480), modTime: time.Unix(1521648129, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
