...
func templatesOutputTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/output.tf", size: 905, mode: os.FileMode(420), modTime: time.Unix(1506970921, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesTlsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/tls.tf", size: 80, mode: os.FileMode(420), modTime: time.Unix(1506970921, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
