...
func templatesConcourse_lbTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/concourse_lb.tf", size: 3940, mode: os.FileMode(480), modTime: time.Unix(1516677969, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesVarsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/vars.tf", size: 504, mode: os.FileMode(480), modTime: time.Unix(1517332798, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
