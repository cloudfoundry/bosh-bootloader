...
func templatesBosh_directorTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/bosh_director.tf", size: 2729, mode: os.FileMode(420), modTime: time.Unix(1510019499, 0)}
...
func templatesConcourse_lbTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/concourse_lb.tf", size: 1572, mode: os.FileMode(420), modTime: time.Unix(1510082507, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesJumpboxTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/jumpbox.tf", size: 361, mode: os.FileMode(420), modTime: time.Unix(1510015574, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
