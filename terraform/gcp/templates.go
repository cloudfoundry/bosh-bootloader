...
func templatesBosh_directorTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/bosh_director.tf", size: 3801, mode: os.FileMode(480), modTime: time.Unix(1515642086, 0)}
...
func templatesCf_dnsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/cf_dns.tf", size: 2734, mode: os.FileMode(480), modTime: time.Unix(1519252345, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesCf_lbTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/cf_lb.tf", size: 6556, mode: os.FileMode(480), modTime: time.Unix(1519252321, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
