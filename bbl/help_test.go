...
var _ = Describe("bbl", func() {
	...
	Context("command specific help", func() {
		DescribeTable("when passing --help flag or help command", func(command, expectedDescription string, args []string) {
			...
			Entry("BOSH CA Cert", "bosh-ca-cert", "Prints BOSH director CA certificate", []string{"help", "bosh-ca-cert"}),
			Entry("BOSH CA Cert", "bosh-ca-cert", "Prints BOSH director CA certificate", []string{"bosh-ca-cert", "--help"}),
